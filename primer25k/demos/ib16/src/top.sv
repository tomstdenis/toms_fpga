...
8'h1c: ib16_bus_data_out_reg <= 16'h7684;
8'h1e: ib16_bus_data_out_reg <= 16'h93fe;
8'h20: ib16_bus_data_out_reg <= 16'h6134;
8'h22: ib16_bus_data_out_reg <= 16'hd5fd;
8'h24: ib16_bus_data_out_reg <= 16'h92fe;
8'h26: ib16_bus_data_out_reg <= 16'h93fe;
8'h28: ib16_bus_data_out_reg <= 16'ha3fe;
8'h2a: ib16_bus_data_out_reg <= 16'h1536;
8'h2c: ib16_bus_data_out_reg <= 16'h7545;
8'h2e: ib16_bus_data_out_reg <= 16'h93fe;
8'h30: ib16_bus_data_out_reg <= 16'ha3fe;
8'h32: ib16_bus_data_out_reg <= 16'h1336;
8'h34: ib16_bus_data_out_reg <= 16'h5335;
8'h36: ib16_bus_data_out_reg <= 16'ha310;
8'h38: ib16_bus_data_out_reg <= 16'h7050;
8'h3a: ib16_bus_data_out_reg <= 16'hd5f5;
8'h3c: ib16_bus_data_out_reg <= 16'h7151;
8'h3e: ib16_bus_data_out_reg <= 16'h7b71;
8'h40: ib16_bus_data_out_reg <= 16'habdc;
8'h42: ib16_bus_data_out_reg <= 16'h6112;
8'h44: ib16_bus_data_out_reg <= 16'hd402;
8'h46: ib16_bus_data_out_reg <= 16'h3000;
8'h48: ib16_bus_data_out_reg <= 16'he008;
8'h4a: ib16_bus_data_out_reg <= 16'h93fe;
8'h4c: ib16_bus_data_out_reg <= 16'h1536;
8'h4e: ib16_bus_data_out_reg <= 16'h7545;
8'h50: ib16_bus_data_out_reg <= 16'h93fe;
8'h52: ib16_bus_data_out_reg <= 16'h1336;
8'h54: ib16_bus_data_out_reg <= 16'h5335;
8'h56: ib16_bus_data_out_reg <= 16'ha310;
8'h58: ib16_bus_data_out_reg <= 16'h7050;
8'h5a: ib16_bus_data_out_reg <= 16'hd5f7;
8'h5c: ib16_bus_data_out_reg <= 16'hd1ef;
