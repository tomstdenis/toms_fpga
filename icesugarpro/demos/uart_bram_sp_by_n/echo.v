...
`else
	...
	reg [10+$clog2(`BLOCKS):0] bram_w_addr;
	reg [7:0] bram_w_data;
	reg bram_w_en;
	reg [10+$clog2(`BLOCKS):0] bram_r_addr;
	wire [7:0] bram_r_data;

	// make a Nx2048x8-bit memory (e.g. N * 2048 bytes of memory)
	bram_sp_nx2048x8  #(.N(`BLOCKS)) bram (
