...
D9: RTI, 				PC = ILR, re-enable interrupts and return
...
DD: WAITF: 				PC = PC + (R[15] == A) ? 1 : 0, // wait for FIFO to have A bytes in it, you need an ISR that stores in the fifo for this to advance
DE: NEG:				A = -A, PC += 1
